...
if st.session_state.logged_in:
    ...
    if uploaded_file is None:
        ...
        try:
            ...
            rev_keywords = ['revenue', 'total', 'subtotal', 'gross sales', 'net sales', 'sales', 'amount', 'price', 'income', 'turnover', 'rev','cash_inflow','net revenue','gross revenue calculated','net sales']
